...
def update_class(class_id):
    ...
    if class_.teacher_id != current_user_id:
        return jsonify({'error': 'Only the class teacher can update this class'}), 403
...
def add_student(class_id):
    ...
    # Check if user is the teacher of this class
    if class_.teacher_id != current_user_id:
        return jsonify({'error': 'Only the class teacher can add students'}), 403
...
def remove_student(class_id, student_id):
    ...
    # Check if user is the teacher of this class
    if class_.teacher_id != current_user_id:
        return jsonify({'error': 'Only the class teacher can remove students'}), 403
